...
>- League of Legends è un videogioco di tipo MOBA (Multiplayer Online Battle Arena) per PC, in cui **2 squadre composte** da 5 giocatori ciascuna si scontrano, assumendo solitamente **5 ruoli diversi** assegnati a **3 corsie specifiche** nella mappa, per raggiungere l'obiettivo di distruggere la struttura principale avversaria.
...
L'ultimo grafico rappresenta il numero di vittorie sul totale delle partite analizzate
```{r,echo=FALSE}
...
>- Ne risulta una quasi parità,con la differenza percentuale che tocca appena l'1.3%
